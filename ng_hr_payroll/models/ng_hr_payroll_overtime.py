...
class hr_overtime(models.Model):
    ...
    number_of_hours = fields.Float(string='Number of Hours', states={
                                   'validate': [('readonly', True)]})
    number_of_days = fields.Float(string='Number of Days', states={
                                  'validate': [('readonly', True)]})
    ...
    date_to = fields.Datetime(string='End Date', readonly=False, states={
                              'validate': [('readonly', True)]})
