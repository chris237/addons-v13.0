        ...
        if days >= notes.days:
            ...
            if reason == 'employee':
                if notes.emp_base == 'fixed':
                    ...
                    domain = [('employee_id', '=', emp_id), ('contract_id',
                                                             '=', contract_id), ('code', '=', 'GROSS')]
            ...
            if employee.category_ids:
                ...
                if days >= cat.notice_period:
                    ...
                    if reason == 'employee':
                        ...
                        res.update(
                            {'company_pay': cat.company_pay, 'emp_pay': 0})
        return {'value': res}
...
class union_policy(models.Model):
    ...
    employee_ids = fields.Many2many(
        'hr.employee', 'union_employee_rel', 'union_id', 'employee_id', string="Employee's")
...
class hr_employee(models.Model):
    ...
    union_ids = fields.Many2many(
        'emp.union', 'union_employee_master_rel1', 'employee_id', 'u_id', string='Unions')
